...
namespace ProjekWinform.Models
{
    public class AlatContext
    {
        ...
        public void Create(AlatPertanian alat)
        {
            using (var conn = connectDB.GetConn())
            {
        ...
        public void UpdateHarga(AlatPertanian alat)
        {
            using (var conn = connectDB.GetConn())
            {
        ...
        public void Restok(int idAlat, int jumlah, int hargaBeli, int idUser)
        {
            using (var conn = connectDB.GetConn())
            {
        ...
        public void Update(AlatPertanian alat)
        {
            using (var conn = connectDB.GetConn())
            {
